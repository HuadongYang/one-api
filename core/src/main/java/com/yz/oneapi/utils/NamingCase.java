...
public class NamingCase {
    public static String toUnderlineCase(CharSequence str) {
        return toSymbolCase(str, CharPool.UNDERSCORE);
    }
    ...
    public static String toKebabCase(CharSequence str) {
        return toSymbolCase(str, CharPool.DASH);
    }
    ...
    public static String toPascalCase(CharSequence name) {
        return StringUtil.firstCharToUpper(toCamelCase(name));
    }
    ...
    public static String toCamelCase(CharSequence name) {
        return toCamelCase(name, CharPool.UNDERSCORE);
    }
    ...
    public static String toCamelCase(CharSequence name, char symbol) {
        ...
        if (StringUtil.contains(name2, symbol)) {
