...
import com.yz.oneapi.utils.ArrayIter;
...
public class Tuple implements Iterable<Object>, Serializable {
    ...
    public final List<Object> toList() {
        return Lists.toList(this.members);
    }
    ...
    public boolean contains(Object value) {
        return Lists.contains(this.members, value);
    }
    ...
    public final Tuple sub(final int start, final int end) {
        return new Tuple(Lists.sub(this.members, start, end));
    }
