...
public class GreaterThanExpr extends AbstractExpr implements Ordered {
    private Object sqlVal;
    public static final String SQL_KEY = ">";
    public static final String SQL_TEMPLATE = SQL_KEY + " ?";

    public GreaterThanExpr(ColumnModel column, Object value) {
        super(column, value);
    }
    ...
    public String toString() {
        return StringUtil.formatWith(sqlSegment(), PLACEHOLDER, sqlVal);
    }
}
