...
public class ParameterMapping {
  ...
  public static class Builder {
    ...
    public Builder(OneApiConfig configuration, String property, TypeHandler<?> typeHandler) {
      parameterMapping.configuration = configuration;
      parameterMapping.property = property;
      parameterMapping.typeHandler = typeHandler;
    }

    public Builder(OneApiConfig configuration, String property, Class<?> javaType) {
      parameterMapping.configuration = configuration;
      parameterMapping.property = property;
    ...
    private void resolveTypeHandler() {
      if (parameterMapping.typeHandler == null && parameterMapping.javaType != null) {
        OneApiConfig configuration = parameterMapping.configuration;
